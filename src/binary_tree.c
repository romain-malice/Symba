...
typedef enum { REAL, INTEGER } VariableType;
...
bool isKnown(Variable *v) { return v->isKnown; }

void *getValue(Variable *v) { return v->value; }
...
bool isEmpty(Tree *t) { return t->size == 0; }

bool isRoot(Tree *t, Node *n) { return t->root == n; }

bool isExternal(Node *n) { return !(n->left || n->right); }

bool isInternal(Node *n) { return n->left || n->right; }

void *getData(Node *n) { return n->data; }

Node *getRoot(Tree *t) { return t->root; }
